...
> Check the attached [testcases]([https://github.com/NitishAryanRaj](https://github.com/NitishAryanRaj/CPU-Scheduling-Algorithms/blob/main/testcases.zip)) for more details.


## Contributors

- [Nitish Kumar](https://github.com/NitishAryanRaj)
